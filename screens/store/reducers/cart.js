    ...
    case ADD_TO_CART:
      ...
      case REMOVE_FROM_CART:
        ...
        if(currentQty>1){
          ...
          updatedCartItem=new CartItem(selectedCartItem.quantity-1,selectedCartItem.productPrice,selectedCartItem.productTitle,(selectedCartItem.sum-selectedCartItem.price));
